...
class MiddleburyDataset(BaseDataset):
                ...
                for im1 in ['im1', 'im1E', 'im1L']:
                    if os.path.exists(image_list[i].replace('im0', im1)):
                        ...
                        if self.mono is not None:
                            _tmp += [image_list[i].replace('im0.png', f'im0_{self.mono}.png'), image_list[i].replace('im0.png', f'{im1}_{self.mono}.png')]
    ...
    def load_sample(self, index):
        ...
        if self.mono is not None:
            data['im2_mono'] = read_mono(self.image_list[index][5])
            data['im3_mono'] = read_mono(self.image_list[index][6])
